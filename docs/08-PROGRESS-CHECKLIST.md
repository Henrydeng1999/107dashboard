...
<div class="progress-meta">
  ...
  <span>基线提交：<code>d8ca30f</code></span>
</div>
...
<div class="progress-summary" aria-label="当前项目摘要">
  ...
  <div class="progress-stat progress-stat-done"><strong>107 / 107</strong><span>后端测试通过</span></div>
  <div class="progress-stat progress-stat-done"><strong>通过</strong><span>前端类型检查与构建</span></div>
  <div class="progress-stat progress-stat-next"><strong>下一步</strong><span>用户级资源摘要</span></div>
</div>
...
<div class="phase-list">
  ...
  <div class="phase-row">
    <div class="phase-heading"><strong>阶段 4 · 日志和资源可视化</strong><span class="status-badge status-active">3 / 4</span></div>
    <div class="progress-track" role="progressbar" aria-label="日志和资源可视化完成度" aria-valuemin="0" aria-valuemax="100" aria-valuenow="75"><span class="progress-fill progress-75"></span></div>
    <p>Fixture 日志、增量读取和作业级资源统计已完成；用户级汇总和真实资源统计平台验收尚未完成。</p>
  </div>
...
| <span class="status-badge status-done">✓</span> | 代码质量 | Ruff、pytest、npm audit | 后端 107 个 pytest 通过，目标 Ruff 通过；0 个生产依赖漏洞 |
...
<div class="notice-grid">
  <div class="notice notice-next"><strong>下一开发项</strong><span>增加当前用户作业数量、状态分布和累计资源的基础摘要，完成阶段 4 的最后一项。</span></div>
  ...
  <div class="notice notice-info"><strong>验证方式</strong><span>Fixture 用于稳定回归和边界覆盖，Native 用于阶段性真实验收：后端 pytest 107 passed、目标 Ruff、前端类型检查和生产构建通过；资源字段按107真实 sacct 输出格式建模。</span></div>
</div>
