...
| <span class="status-badge status-done">✓</span> | 四模块统一工作台 | 可搜索且可整体收起的侧栏、无圆框右转下 SVG 子导航、统一页脚、作业管理、诊断报告、项目评价和 AI 工作台 | Ctrl/Cmd+K、过滤结果、72px 收起宽度、chevron 中心与零边框、长页 footer 间距、无横向溢出、前端类型检查与发布构建通过 |
